...
class SemanticCache:
    ...
    async def lookup(
        ...
        Returns (ChatCompletionResponse, similarity) or (None, None).
        """
        ...
        # Get all entry UUIDs in this scope
        ...
        if best_entry_data is not None and best_similarity >= self.similarity_threshold:
            ...
            return response, round(best_similarity, 4)
    ...
    async def wait_for_cached_result(
        ...
        while time.monotonic() < deadline:
            ...
            result, similarity = await self.lookup(

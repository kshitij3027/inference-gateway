...
resource "aws_security_group" "ecs" {
  ...
  description = "Security group for ECS gateway tasks"
  vpc_id      = aws_vpc.main.id
  ...
  egress {
    description = "All outbound (LLM API calls, ECR, etc.)"
    from_port   = 0
    to_port     = 0
    protocol    = "-1"
    cidr_blocks = ["0.0.0.0/0"]
...
# -----------------------------------------------------------------------------
# ECS Execution Role (used by ECS agent to pull images, push logs, etc.)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# ECS Task Role (assumed by the running container — minimal permissions)
# -----------------------------------------------------------------------------
